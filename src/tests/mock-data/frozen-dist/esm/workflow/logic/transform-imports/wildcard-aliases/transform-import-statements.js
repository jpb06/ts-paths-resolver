...
export const transformImportStatements = ({ distPath, rootDir, sourceFilePath, entryPoint, }, pathsAliases, fileContent) => pipe(Effect.gen(function* () {
    ...
    const importMatch = fileContent.match(importPathRegex(aliasWithoutEndWildcard));
    if (importMatch) {
    ...
    const dynamicImportMatch = fileContent.match(dynamicImportPathRegex(aliasWithoutEndWildcard));
